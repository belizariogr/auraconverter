...
- Preview fallback paths match Node: `{voice}_{locale}_s100_{QWEN_TTS_PREVIEW_CACHE_VERSION}` (also accepts legacy without `sNNN`; default version `1.7b-narrate-v1`).
